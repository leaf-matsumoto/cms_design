            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="" style="text-align:center;margin:30px 0px;font-size:25px;">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="">
                                <a href="{{ admin_url('auth/logout') }}" class="btn btn-danger btn-flat btn-block">{{ trans('admin.logout') }}</a>
                            </div>
                        </li>
                    </ul>
                </li>
