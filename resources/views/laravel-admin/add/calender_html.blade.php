...
<div class="container calender" style="float:left;margin-left:5%;width:80%;">
    <h3 class="mb-5" style="margin-bottom:20px;">
        ...
        <a href="#" style="background-color:#808080;padding:3px 10px;color:#fff;border-radius:5px;font-size:15px;">today</a>
        <span style="margin-left:20px;font-size:20px;">
            <span style="font-size:30px!important;">2022</span>&thinsp;年&thinsp;<span style="font-size:30px!important;">7</span>&thinsp;月
        </span>
        <button type="button" class="btn js-open button-open" data-id="1" style="color:#ffffff;background-color:#fff;">仮</button>
    </h3>
