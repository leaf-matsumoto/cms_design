    ...
    <div class="fields-group">
        <div class="col-md-12">
            ...
            <div class="form-group label-all">
                ...
                <fieldset>
                    <legend class="form-group col-sm-10" style="font-size:13px;font-weight:200;padding:10px 7px;margin-top:10px;">子商品選択項目&nbsp;①&nbsp;</legend>
                ...
                <fieldset>
                    <legend class="form-group col-sm-10" style="font-size:13px;font-weight:500;padding:10px 7px;margin-top:10px;">子商品選択項目&nbsp;②&nbsp;</legend>
