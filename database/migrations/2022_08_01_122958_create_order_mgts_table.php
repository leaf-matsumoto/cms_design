...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_mgts', function (Blueprint $table) {
            ...
            $table->string('order_day')->nullable();//本オーダー日時
            $table->string('order_content')->nullable();//注文内容
            $table->string('order_status')->nullable();//オーダーステータス
            $table->string('pay_situation')->nullable();//決済ステータス
            $table->string('order_situation')->nullable();//注文ステータス
            $table->string('order_kinds')->nullable();//オーダー種別
            $table->string('call_num')->nullable();//呼出番号
            ...
            $table->string('call_day')->nullable();//呼出日時
